...
int Ensemble_Job_Camera_Set_Auto_Focus_OnOff(const std::string job_id, const bool on, const float x=-1, const float y=-1, const float width=-1, const float height=-1);
...
int Ensemble_Camera_Set_Auto_Focus_OnOff(const bool on, const float x=-1, const float y=-1, const float width=-1, const float height=-1);
