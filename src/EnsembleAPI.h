...
public:
	...
	std::string Ensemble_Task_Get_Name(const std::string id) ;
	int 		Ensemble_Task_Set_Name(const std::string id, const std::string name) ;
	int 		Ensemble_Task_Get_Image(const std::string id,const int type_option,  const int width, const int height, ImageBuf* p_buf) ;
	int 		Ensemble_Task_Get_Image(const std::string id, const int type_option, ImageBuf* p_buf) ;
	int 		Ensemble_Task_Get_ObjectImage(const std::string id,const int type_option,  const int width, const int height, ImageBuf* p_buf) ;
	int 		Ensemble_Task_Get_ObjectImage(const std::string id, const int type_option, ImageBuf* p_buf) ;
	int 		Ensemble_Task_Get_Result_Image(const std::string id, const int type_option, const int width, const int height, ImageBuf* p_buf) ;
	int 		Ensemble_Task_Get_Result_Image(const std::string id, const int type_option, ImageBuf* p_buf) ;		
    int 		Ensemble_Task_Set_MaskArea(const std::string id, float x, float y, float w, float h, bool inverse);
    int 		Ensemble_Task_Undo_MaskArea(const std::string id);
    int 		Ensemble_Task_Del_MaskArea(const std::string id);
	int 		Ensemble_Task_Get_FeatureLevel(const std::string id);
	int 		Ensemble_Task_Set_FeatureLevel(const std::string id, const int level);
	int 		Ensemble_Task_Get_UseCustomFeatureOption(const std::string id);
	int 		Ensemble_Task_Set_UseCustomFeatureOption(const std::string id, const bool b_use);
	int 		Ensemble_Task_Get_Feature_Option(const std::string id, int* out_param1, int* out_param2, int* out_param3, int* out_param4);
	int 		Ensemble_Task_Set_Feature_Option(const std::string id, const int param1, const int param2, const int param3, const int param4);	
	int 		Ensemble_Task_Get_Type_Info(const std::string id) ;
	std::string Ensemble_Task_Get_Addable_Subjob_List_Info_Xml(const std::string id) ;
	int 		Ensemble_Task_Set_Python_Code(const std::string id, const std::string code) ;
	std::string Ensemble_Task_Get_Python_Code(const std::string id) ;
	...
	int 		Ensemble_Job_Set_Feature_Erase(const std::string id, const float x, const float y, const float width, const float height) ;
	int 		Ensemble_Job_Del_Feature_Erase(const std::string id) ;
	...
	//Config Detect Object
	int 		Ensemble_Find_Object_Set_SelectObject(const std::string id, const float left_top_x, const float left_top_y, const float right_top_x, const float right_top_y, const float right_bottom_x, const float right_bottom_y, const float left_bottom_x, const float left_bottom_y, const int margin=0) ;
	int 		Ensemble_Find_Object_Del_SelectObject(const std::string id) ;
    int 		Ensemble_Find_Object_Set_Ref_Point(const std::string id, const float x, const float y) ;
	...
	std::string Ensemble_Tool_Get_TypeName(const int type) ;
